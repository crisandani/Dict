...
echo'<textarea class="camp" name="CampDescriere" rows="13" cols="130">'.$description.'</textarea>';
echo'<button  type="submit" value="Submit" name="modifica">Modifica</button>';
echo'</form>';
}
...
echo'<p  class="p">Descriere:</p>';
echo'<textarea class="camp" name="CampDescriere" rows="13" cols="130">Here....</textarea>';
echo'<button  type="submit" value="Submit" name="adauga">Adauga</button>';
echo'</form>';
